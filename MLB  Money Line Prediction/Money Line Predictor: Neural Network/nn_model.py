...
Original file is located at
    https://colab.research.google.com/drive/1uE4tq8rxCyuz1XVvK34MDb0C28HSKbAC
"""
...
NN_model.add(tf.keras.layers.Dense(units = 120, activation = 'relu', name = 'fc1', input_shape = (25,)))
NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
#NN_model.add(tf.keras.layers.Dense(units = 600, name = 'fc2', activation = 'relu'))
#NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
#NN_model.add(tf.keras.layers.Dense(units = 150, name = 'fc3', activation = 'relu'))
#NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
#NN_model.add(tf.keras.layers.Dense(units = 60, name = 'fc4', activation = 'relu'))
#NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
#NN_model.add(tf.keras.layers.Dense(units = 30, name = 'fc5', activation = 'relu'))
#NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
NN_model.add(tf.keras.layers.Dense(units = 15, name = 'fc6', activation = 'relu'))
NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
NN_model.add(tf.keras.layers.Dense(units = 2, name = 'fc7', activation = 'relu'))
NN_model.add(tf.keras.layers.Dropout(rate = 0.5))
NN_model.add(tf.keras.layers.Dense(units = 1, name = 'fc8'))


print(NN_model.summary())

NN_model.compile(optimizer = 'adam', loss = tf.keras.losses.BinaryCrossentropy(), metrics = ['BinaryAccuracy'])

history = NN_model.fit(X_train, Y_train, epochs = 100, verbose = 0)
