...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun  6 18:46:56 2021
...
param_grid = {'n_estimators': Integer(10, 500), 'max_features': Categorical(['auto', 'sqrt','log2']), 'max_depth': Integer(1,10) }
...
model = BayesSearchCV(model, param_grid, n_iter = 50, scoring = 'accuracy', cv=cv, return_train_score = True, refit = True).fit(X_train, Y_train)
