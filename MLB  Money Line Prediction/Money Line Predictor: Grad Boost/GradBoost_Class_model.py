...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 20:24:16 2021
...
param_grid = {'n_estimators': Integer(100, 1000), 'learning_rate': Real(0.01, 0.5), 'max_depth': Integer(1,100) }


#Generate the ML model we will use
model = GradientBoostingClassifier()


cv = KFold(5, shuffle=True, random_state=1).get_n_splits(X_train)

model = BayesSearchCV(model, param_grid, n_iter = 100, scoring = 'accuracy', cv=cv, return_train_score = True, refit = True).fit(X_train, Y_train)
