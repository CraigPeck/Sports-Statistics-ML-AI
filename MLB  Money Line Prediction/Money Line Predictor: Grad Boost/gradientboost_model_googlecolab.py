# -*- coding: utf-8 -*-
"""GradientBoost_model_googleColab.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FRBDa99eyOjUgAxmiCpGtrmbQI6sAef1
"""
...
file_feature = pd.DataFrame({'Runs_Scored EMA3': features['Runs_Scored EMA3'],
                             ...
                             'On_Base_Percentage EMA3' : features['On_Base_Percentage EMA3'],
                             'Slugging_Percentage EMA3' : features['Slugging_Percentage EMA3'],
                             'Pitches_Faced EMA3' : features['Pitches_Faced EMA3'],
                             'Pitches_Pitched EMA3' : features['Pitches_Pitched EMA3'],
                             'Strikes_Earned EMA3' : features['Strikes_Earned EMA3'],
                             'Strikes_Given EMA3' : features['Strikes_Given EMA3'],
                             'Base_Out_Runs EMA3' : features['Base_Out_Runs EMA3'],
                             'Home_Runs_Givenup EMA3' : features['Home_Runs_Givenup EMA3'],
                             'Grounded_Balls_Allowed EMA3' : features['Grounded_Balls_Allowed EMA3'],
                             'Fly_Balls_Allowed EMA3' : features['Fly_Balls_Allowed EMA3'],
                             'Line_Drives_Allowed EMA3' : features['Line_Drives_Allowed EMA3'],
                             'Pitcher_Win_Contribution EMA3': features['Pitcher_Win_Contribution EMA3'],
...
#param_grid = {'n_estimators': Integer(10, 100), 'learning_rate': Real(0.01, 0.5), 'max_depth': Integer(10,30) }

param_grid = {'max_depth': Integer(10,30) }
...
test_set_predictions.to_csv('test_predictions_v7.csv')
!cp test_predictions_v7.csv "drive/My Drive/"

predictions_and_probs.to_csv('predictions_and_probs_v7.csv')
!cp predictions_and_probs_v7.csv "drive/My Drive/"