...
# -*- coding: utf-8 -*-
"""
Created on Mon May 10 21:12:16 2021
...
def XGBoost(X_train, Y_train, X_test, Y_test, file_feature, real_game_score, file_fit, Blender_X_test):
  ...
  ## Create a grid search for optimal hyperparameters 
    ...
    plt.title('Game Score Prediction: XGBoost')
