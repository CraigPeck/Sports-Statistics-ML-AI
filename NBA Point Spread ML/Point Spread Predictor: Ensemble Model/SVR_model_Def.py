...
# -*- coding: utf-8 -*-
"""
Created on Mon May 10 20:53:28 2021
...
def SVRegress(X_train, Y_train, X_test, Y_test, file_feature, real_game_score, file_fit, Blender_X_test):
   ...
   ## Create a grid search for optimal hyperparameters 
    param_grid = {'C': sp.randint(1,30), 'degree': sp.randint(2,8)}
    ...
    plt.title('Game Score Prediction: SVR')
